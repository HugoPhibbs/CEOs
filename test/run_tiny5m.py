...
# dataset_path = "/home/hphi344/Documents/CEOs/test/datasets/tiny5m/tiny5m_dataset.bin"
# queries_path = "/home/hphi344/Documents/CEOs/test/datasets/tiny5m/tiny5m_queries.bin"

# X = np.fromfile(dataset_path, dtype=np.float32)
# Q = np.fromfile(queries_path, dtype=np.float32)

X = np.loadtxt("/shared/Dataset/ANNS/CosineKNN/Tiny5m_X_5000000_384.txt", dtype=np.float32, delimiter=None)
Q = np.loadtxt("/shared/Dataset/ANNS/CosineKNN/Tiny5m_Q_1000_384.txt", dtype=np.float32, delimiter=None)
